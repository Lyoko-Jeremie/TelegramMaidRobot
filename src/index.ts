...
let adminIdList: Map<number, UserChatInfo> = new Map<number, UserChatInfo>();
...
let hookListenerIdList: Map<number, WebHookListenerIdItem> = new Map<number, WebHookListenerIdItem>();
